    ...
    public class Bot
    {
        ...
        public void makeAccount()
        {
            try
            {
                ...
                SDataPayload address = feed2.Entries.ElementAt(choice).GetSDataPayload();
        ...
        public SDataPayload makeAccountWithName(SDataPayload leadPayload)
        {
            ...
            try
            {
                ...
                payload.Values["Region"] = region[0];
                string accountMan = region[1];
                Log("Account Manager: " + accountMan, fileName);
                Log("Region: " + region[0], fileName);
                ...
                payload.Values["AccountManager"] = accountManager.Values["userId"];
        ...
        public SDataPayload makeContactWithName(SDataPayload leadPayload)
        {
            ...
            try
            {
                ...
                payload.Values["Status"] = "Active";
                payload.Values["Address"] = actPayload.Values["Address"];
                /*payload.Values["Address"] = new SDataPayload
                {
                    ResourceName = "addresses",
                    Values = {
